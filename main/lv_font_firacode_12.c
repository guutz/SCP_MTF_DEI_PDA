 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --bpp 1 --size 12 --no-compress --font FiraCode-SemiBold.ttf --symbols ~!@#$%^&*()_+QWERTYUIOP{}|ASDFGHJKL:"ZXCVBNM<>?`1234567890-=qwertyuiop[]\asdfghjkl;'zxcvbnm,./█  --format lvgl -o lv_font_firacode_12.c
 ******************************************************************************/
...
#ifndef LV_FONT_FIRACODE_12
#define LV_FONT_FIRACODE_12 1
#endif

#if LV_FONT_FIRACODE_12
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 623, .adv_w = 118, .box_w = 7, .box_h = 15, .ofs_x = 0, .ofs_y = -4}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_firacode_12 = {
#else
lv_font_t lv_font_firacode_12 = {
#endif
